...
{
    include("conexion.php");
    $query = "SELECT * FROM propiedades  ORDER BY fecha_alta ASC/*DESC*/";
    $result = mysqli_query($conn, $query);
    return $result;
}
            ...
            <div id="configuracion">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                        ...
                        <div class="fila">
                            ...
                            <select name="tipo_visualizacion_propiedades" id="tipo_visualizacion_propiedades" class="input-entrada-texto" onchange="tipoDeMuestra(this.value)">
                                <option value="f" <?php if ($config['tipo_visualizacion_propiedades'] == "f") {
                                                        echo "selected";
                                                    } ?>>Mostrar automaticamente por orden de carga</option>
                    ...
                    <div class="box-configuracion">
                        ...
                        <label for="horarios">Facebook(nombre de usuario)</label>
                        <input type="text" value="<?php echo $config['facebook'] ?>" placeholder="Dirección de facebook" name="facebook" class="input-entrada-texto">
                        
                        <label for="horarios">Instagram (nombre de usuario)</label>
                        <input type="text" value="<?php echo $config['twitter'] ?>" placeholder="Dirección de Instagram" name="twitter" class="input-entrada-texto">
